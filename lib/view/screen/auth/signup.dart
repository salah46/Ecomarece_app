...
class SignUp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<SignUpController>(builder: (controllerSignup) {
        return controllerSignup.statusResquest == StatusResquest.laoding
            ? Center(
                child: Text("Loading"),
              )
                      ...
                      child: Form(
                        ...
                        child: Column(
                          children: [
                            CustomeTextField(
                                valide: (p0) {
                                  return validInput(p0!, 4, 100, "username");
                                },
                            ...
                            CustomeTextField(
                                ...
                                textEditingController: controllerSignup
